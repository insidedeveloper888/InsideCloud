/**
 * Parser for SQL Accounting "GL Document Listing - OR"
 *
 * Expected structure:
 ...
 * Main rows have "-" in column 0 and "OR" (or doc type) in column 1
 */
 ...
 */
export function parseGLDocumentOR(rawData) {
  ...
  return {
    ...
    metadata: {
      ...
      docType: 'GL Document Listing - OR',
