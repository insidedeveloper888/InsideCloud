          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-4">
            <div className="grid grid-cols-2 md:grid-cols-12 gap-3">
              ...
              <div className="col-span-1 md:col-span-2 flex items-end">
                <button
                  onClick={onAddItem}
                  className="w-full px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all flex items-center justify-center space-x-1"
                >
                ...
                {newPO.items.map((item, index) => (
                  <div key={index} className="flex items-center justify-between bg-white border-2 border-gray-200 rounded-xl p-3">
                    ...
                    <div className="text-right px-3">
                      ...
                      <p className="font-bold text-blue-600">RM {(item.quantity * item.unit_cost).toFixed(2)}</p>
                    </div>
                    <button
